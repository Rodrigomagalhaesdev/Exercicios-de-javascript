...
*/
const my3FavoriteTVShows = ["dark", "stranger things", "narcos"];

const [favoriteSeries1, favoriteSeries2, favoriteSeries3] = my3FavoriteTVShows;


const setence = `Minhas series favoritas são: ${favoriteSeries1}, ${favoriteSeries2} e ${favoriteSeries3}`;
// console.log(setence);
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
const result = my3FavoriteTVShows.length === 3 ? true : false;
// console.log(result)
...
const isRandomTVShowIncluded = my3FavoriteTVShows.includes("Watchman");
...
const falsyCount = falsyValues.length;

/* console.log(`Todos os ${falsyCount} itens do array "falsyValues" são falsy.
 inclusive o ${falsyValues.indexOf(0)}`)
/*
...
const crazyConversion = Boolean(crazyOperation);
 //console.log(typeof crazyConversion)
...
*/
const isNotAString = randomTVShow === String ? true : false;
